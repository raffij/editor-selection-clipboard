...
editor.blockList.push(new Image({ src: 'https://madebymany-v2-prod.s3.amazonaws.com/uploads/blog/featured_image/1183/large_react_native_series_2.png', caption: '' }))
editor.blockList.push(new Image({ src: undefined, caption: '' }))
